...
export const CATEGORIES: Category[] = [
  ...
  // 🧵 የብሔረ-ብሔረሰዎች ባህል እና የጨርቅ ዓይነቶች (Heritage & Fabrics)
  {
    id: 'axum_fetel',
    tag: '#የኣክሱም_ፈትል',
    nameAm: 'የኣክሱም ፈትል እና ማግ (ንጹህ ጥጥ)',
    nameTi: 'ናይ ኣኽሱም ፈትሊን ማግን (ጽሩይ ጡጥ)',
    nameEn: 'Axum Pure Handspun (Fetil & Mag)',
    shortAm: 'ፈትልና ማግ',
    shortTi: 'ፈትሊን ማግን',
    shortEn: 'Fetil & Mag',
  ...
  },
  {
    id: 'chiffon',
    tag: '#የሽፎን_ቀሚስ',
    nameAm: 'የሽፎን ጨርቅ አልባሳት (Chiffon)',
    nameTi: 'ናይ ሺፎን ክዳውንቲ (Chiffon)',
    nameEn: 'Elegant Chiffon Dresses',
    shortAm: 'ሽፎን',
    shortTi: 'ሺፎን',
    shortEn: 'Chiffon',
    group: 'heritage_fabrics',
  },
  {
    id: 'china_fabric',
    tag: '#የቻይናጨርቅ_ልብስ',
    nameAm: 'የቻይና ጨርቅ አልባሳት (China Fabric)',
    nameTi: 'ናይ ቻይና ጨርቂ ክዳውንቲ',
    nameEn: 'China Fabric Traditional Attire',
    shortAm: 'የቻይና ጨርቅ',
    shortTi: 'ቻይና ጨርቂ',
    shortEn: 'China Fabric',
    group: 'heritage_fabrics',
  },
  {
    id: 'nkr',
  ...
  },
  {
    id: 'other_fabric',
    tag: '#ሌላ_የጨርቅ_ምርጫ',
    nameAm: 'ሌላ የጨርቅ ምርጫ (Other Fabric)',
    nameTi: 'ካልእ ናይ ጨርቂ ምርጫ (Other)',
    nameEn: 'Other Custom Fabric Choice',
    shortAm: 'ሌላ ጨርቅ (Other)',
    shortTi: 'ካልእ ጨርቂ (Other)',
    shortEn: 'Other Fabric',
    group: 'heritage_fabrics',
  },
  {
    id: 'raya',
...
export const STORE_INFO = {
  ...
  email: 'info@abelhabesha.com',
  emailUrl: 'mailto:info@abelhabesha.com?subject=Inquiry%20-%20Abel%20Habesha%20Traditional%20Attire',
  telegramUser: 'AbelDesignChat',
  telegramUrl: 'https://t.me/AbelDesignChat',
  telegramChannel: 'https://t.me/abelhabesha1',
  telegramChannelUser: 'abelhabesha1',
  whatsappUrl: 'https://wa.me/251913312314',
  website: 'https://t.me/abelhabesha1',
  ...
  socialLinks: {
    website: 'https://t.me/abelhabesha1',
    telegramChannel: 'https://t.me/abelhabesha1',
    email: 'mailto:info@abelhabesha.com?subject=Inquiry%20-%20Abel%20Habesha%20Traditional%20Attire',
